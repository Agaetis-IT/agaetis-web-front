    ...
    <div className={clsx('flex flex-col my-6 md:my-12 justify-between md:p-8 mx-auto md:max-w-md', className)}>
      <div className={clsx('md:max-w-xs mx-4 md:mx-0 self-center', descBlockClass)}>
        ...
        <Link href={href}>
          <Button
            href={href}
            className="w-40 block mx-auto md:mx-0 text-center px-6 py-2 leading-none rounded-full uppercase mt-4 mb-6 md:mb-0 bg-orange text-white text-xs font-semibold"
          >
            {buttonContent}
          </Button>
        </Link>
