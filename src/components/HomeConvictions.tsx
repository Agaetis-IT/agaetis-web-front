...
export default function HomeConvictions({ title, convictions }: Props) {
  return (
    <div className="bg-orange-500 py-8 md:p-16 xl:px-32">
      ...
      <div className="flex flex-col md:flex-row justify-center md:justify-start flex-nowrap md:flex-wrap text-white mb-0 mt-8 md:my-8 lg:my-0 px-4 sm:px-12 md:px-4">
