  ...
  return (
    <>
      <div className="hidden p-16 lg:px-24 lg:p-16 md:flex flex-row">
        <img className="my-auto w-1/3" src={joinUsImageDesktop} title="Rejoignez-nous !" alt="Rejoignez-nous !" width={560} height={445} loading="lazy" />
        <div
          style={{
      ...
      <div className="flex flex-col md:flex-row md:hidden p-4">
        ...
        <div className="flex flex-row-reverse justify-between sm:justify-around mb-8">
          <img className="h-32 w-32" src={joinUsImageMobile1} title="Rejoignez-nous !" alt="Rejoignez-nous !" width={320} height={320} loading="lazy" />
          <Button
            href="/agaetis"
        ...
        <div className="flex flex-row justify-between sm:justify-around mb-8">
          <img className="h-32 w-32" src={joinUsImageMobile2} title="Rejoignez-nous !" alt="Rejoignez-nous !" width={360} height={360} loading="lazy" />
          <Button
            href="/jobs"
