...
=======
      ...
      <div className="hidden md:inline md:ml-16">
        <Button href="#" className="px-6 py-3 leading-none rounded-full uppercase mt-4 md:mt-0 text-white bg-orange">
          Contact
        </Button>
      </div>
      <div className="inline md:hidden text-xs font-medium md:flex-grow">
        <Button href="#" className="md:mt-0 md:mr-16 md:ml-1 p-2 md:p-0 text-white">
          Contact
        </Button>
      </div>
      {/*Languages selection */}
      <div className="text-xs md:ml-4 flex flex-row items-center p-2 md:p-0 text-white">
        <Button href="#" className="mr-1 text-white">
          EN
        </Button>
